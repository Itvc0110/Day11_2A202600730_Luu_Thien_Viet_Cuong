...
async def part3_testing():
    ...
    if unprotected and protected:
        ...
        print("Comparison did not produce both result sets. Check model/API setup.")
    ...
    if results:
        ...
        print("No security test results produced. Check attack prompts and model/API setup.")
